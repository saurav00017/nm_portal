...
file_name = "manull_invites" + str(datetime.now().strftime("%H:%M:%S")) + ".csv"

mannual_colleges = [
    {
        "college_code": 1119,
        "email": "mani@saec.ac.in",
        "mobile": "9884620510"
    },
]
# l
        ...
        try:
            ...
            if True:
                ...
                data = [college_info.college_code, college_info.college_name,
                        ...
                        password, is_sms_sent, is_email_sent, str(datetime.now().strftime("%H:%M:%S")), college_info.email, college_info.mobile]
