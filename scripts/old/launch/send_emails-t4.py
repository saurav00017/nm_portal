...
).exclude(registration_status__gte=5).order_by('-phone_number')
...
file_name = "sms_t4_2nd_dec" + str(now.strftime("%H:%M:%S")) + ".csv"
count = 0
# l
    ...
    for student in college_students:
        ...
        if roll_no != '':
            ...
            if student.college.college_type == 1:
                ...
                username_pref = 'as' + str(student.college.college_code).strip()
